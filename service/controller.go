...
type Controller interface {
	CreatePermit(ctx context.Context, reqID string, fileID string, userID string, status string, statusObject *pb.StatusObject) (Permit, error)
	...
	UpdatePermitStatus(ctx context.Context, reqID string, status string, statusObject *pb.StatusObject) (bool, error)
